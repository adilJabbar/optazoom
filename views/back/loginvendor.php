		...
		<div class="cls-content">
			<div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 50px !important;">
				<div class="panel-body">
					...
					<form action="<?php echo base_url(); ?>vendor/login/" method="post">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group text-right main_login">
                                    ...
                                    <button type="submit" class="btn btn-login btn-labeled btn-block fa fa-unlock-alt snbtn">Submit</button>
