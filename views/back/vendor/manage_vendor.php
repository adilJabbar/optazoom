                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="panel panel-primary">
                                          <div class="panel-heading">
                                            <h3 class="panel-title"><?php echo translate('Views');?></h3>
                                          </div>
                                          <div class="panel-body">
                                             You are getting noticed<br>
                                            Total number or views on your profile:
                                            <span class="text-primary"><?php echo $row['views']; ?></span>
                                          </div>
                                        </div>
                                    </div>
                                </div>
