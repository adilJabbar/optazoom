<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow">Deals</h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('add','deals','<?php echo translate('successfully_added!'); ?>','deal_add',''); proceed('to_list');">
                                Create Deal
                            </button>
                            <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
                                style="display:none;"  onclick="ajax_set_list();  proceed('to_add');">back to deals
                            </button>
                        </div>
                    <!-- LIST -->
