...
<nav class="navbar navbar-default navbar-fixed-top " role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url();?>message">Vendor Message</a>
  </div>

  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav nav-pills pull-right" role="tablist">
      <li role="presentation"><a href="#">New messages <span class="badge" id="new_count_message"><?php echo $this->db->where('read_status',0)->count_all_results('vendor_message');?></span></a></li>
    </ul>
  </div>
...
<hr>
<footer class="text-center">Optazoom &#169</footer>
<hr>
