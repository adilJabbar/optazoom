                ...
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="information-title" style="margin-bottom: 0px;"><?php echo translate('my_profile');?></div>
                        <ul class="pleft_nav">
                            ...
                            <a class="pnav_query" href="#"><li><?php echo translate('Queries');?></li></a>
                            ...
                            <a class="pnav_ticket" href="#"><li><?php echo translate('support_ticket_to_admin');?></li></a>
...
<script>
    ...
    $('.pnav_query').on('click',function(){
        $("#profile_content").html(loading_set);
        $("#profile_content").load("<?php echo base_url()?>home/profile/query");
        $(".pleft_nav").find("li").removeClass("active");
        $(".pnav_query").find("li").addClass("active");
    });
    ...
    $('.pnav_message_to_vendor').on('click',function(){
        ...
        <?php if(isset($product_added_by_id)){ ?>
            $("#profile_content").load("<?php echo base_url()?>home/profile/message_to_vendor/<?php echo $product_added_by_id; ?>");
        <?php } else{?>
            $("#profile_content").load("<?php echo base_url()?>home/profile/message_to_vendor");
        <?php } ?>
