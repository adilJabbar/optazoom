<!-- PAGE -->
<section class="page-section image testimonials home-3-blog" id="blok" style="background: url(<?php echo base_url(); ?>uploads/others/parralax_blog.jpg) center top no-repeat; background-attachment:fixed; background-size:cover;">
