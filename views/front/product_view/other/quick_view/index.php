...
?>
<section class="page-section" itemscope itemtype="http://schema.org/Product" id="q_view">
    <div class="row product-single py-5">
        <div class="col-md-5 hidden-xs hidden-sm">
            <div class="row">
                <div class="col-md-2 others-img">
                    ...
                    <!--    <img class="img-responsive img" data-src="https://s3.amazonaws.com/images.seroundtable.com/google-rainbow-texture-1491566442.jpg" alt=""/>-->
                    <!--</div>-->
                    <?php
                        $i++;
                        }
    	...
    	?>" alt=""/>
                ...
                <div class="col-md-offset-1 col-md-9">
                    <img class="img-responsive main-img" id="set_image" src="<?php
    	$image=$this->crud_model->get_product_image($row['product_id']);
    	echo $image[0]->image_link;
    	?>" alt=""/>
                </div>
