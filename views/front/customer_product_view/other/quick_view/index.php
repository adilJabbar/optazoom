...
?>
<section class="page-section" id="q_view1">
    <div class="row product-single" style="margin-top: 0px;">
        ...
        <div class="col-md-7">
            ...
            <div class="added_by" style="padding-bottom: 10px;">
                ...
                <?php echo translate('phone_no.:').'<a class="show_number" style="cursor: pointer;margin-left:4px;font-size: 16px;line-height: 15px;color:#515b6f;text-decoration: underline;"><b>Show Number</b></a><b class="text-info number_text" style="margin-left:4px;font-size: 18px;line-height: 15px;display: none;">'.$phone.'</b>';?>
            </div>
