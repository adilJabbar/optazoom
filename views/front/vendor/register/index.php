<div id="log_in">
    <section class="page-section color get_into log_bg">
    <div class="container" id="login">
        <div class="row margin-top-0">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                <div class="logo_top">
                    <!--<a href="<?php echo base_url()?>">-->
                        <p class="text-center form-type">SIGN UP</p>
                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control pass2 required" type="text" name="phone" placeholder="Phone Number in International Format" data-toggle="tooltip" title="Phone Number">
                            </div>
                            <div id='pass_note'></div> 
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 px-0" style="margin-bottom:-15px">
                            <div class="title">
                                <?php echo translate('vendor_registration');?>
                                <div class="option">
                                	<?php echo translate('already_a_vendor_?_click_to_');?>
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-center">
                            <input type="button" class="btn butn" value="Open Your Wholesale Account Today">
                        </div>
                    </div>
                </div>
            </div>
